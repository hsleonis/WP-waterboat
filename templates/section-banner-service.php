    ...
    <div class="row">
        <div class="col-xs-6 col-mb-12">
            <div class="banner-left-block">
                <p class="welcome"><?php echo TmxLibraryIncluder::getAdmin()->getOption('service_subtitle'); ?></p>
                <h1 class="title"><?php echo TmxLibraryIncluder::getAdmin()->getOption('service_title'); ?></h1>
